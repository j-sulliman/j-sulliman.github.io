...
That's it for this week's update on using DCNM APIs to build dashboards using grafana.  Thank you for reading through. We've scratched the surface of what's possible, but hopefully demonstrated how Cisco APIs and opensource software such as grafana can be used to build your own cross-domain dashboards.

I'll update this site's content as we cover remaining architectures.
