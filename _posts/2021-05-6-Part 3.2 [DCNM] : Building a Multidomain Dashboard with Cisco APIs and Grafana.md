...
* Map the keys of interest in the JSON dictionary output to our models fields
...
django.setup()
```
You can use PgAdmin to verify devices have been retrieved and written to the database
