...
In this update we outline of the virtual lab topology used as the sandbox to explore APIs and Visualisations with Grafana and DCNM.  If you already have a DCNM environment available, you can skip this page and continue to Part 3b.
...
3b | DCNM & EVPN VXLAN | Work In Progress | Visualising DCNM APIs with Grafana.
...
__Note:__ If CPU, Disk or memory for DCNM is under-provisioned, you'll be redirected to *https://[DCNM-IP]:2443/resourceerror.html*.  Shutdown the DCNM virtual-machine and assign the minimum virtual machine requirements as above.
...
copy run st
```
__Note__ – With a DHCP assigned address on Mgmt0, you might encounter -  *“Error during configuration read or intent”* error when Saving and Deploying configuration.  Statically assigned IP addresses to Mgmt0 resolved in my case.
...
### Multi-Site Domain (MSD) Deployment
...
##### Fabric Members and Operational State
...
This ends the overview of DCNM Virtual Lab setup.  We'll look into DCNM APIs and Dashboards in the next update.
