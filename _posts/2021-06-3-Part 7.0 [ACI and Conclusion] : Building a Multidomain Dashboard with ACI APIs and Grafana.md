...
With the call home email alert functionality of ACI and other Cisco products, do we really need to use a seperate fucntion to implement email based alerts? Short answer, no.  But if we wanted to include devices in our dashboard that don't support call home this could be useul..worst case, we have sample code in our library to use for another project later.
