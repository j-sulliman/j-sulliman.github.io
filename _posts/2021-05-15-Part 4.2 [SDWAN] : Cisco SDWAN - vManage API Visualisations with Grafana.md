...
##### Create a similar function, this time mapping the output of the API call to **/device/counters** to the models file/postgres Database.  Note: Again - you view the parameters/expected output of the API call in the [vManage API Reference](https://developer.cisco.com/docs/sdwan/#!reference-device-state-and-statistics)
```python
...
```
##### And validate that device counters been saved to the database. You could use PgAdmin as before, or code similar to below to validate from python:
...
If you've followed along successfully your SD-WAN Grafana Dashboard will look similar to below:
![SD-WAN Dashboard](https://github.com/j-sulliman/j-sulliman.github.io/blob/master/images/SD-WAN_Dash.png?raw=true)


If you've through to the end, thank you for reading through.
