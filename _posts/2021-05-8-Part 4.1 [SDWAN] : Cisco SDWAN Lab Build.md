...
* (1) Documenting the SDWAN Sandbox Lab deployment for anyone that's interested in learning, demos, testing
...
Refer to [codingpackets SDWAN Self Host Lab](https://github.com/j-sulliman/j-sulliman.github.io/blob/master/images/Plug_Play_Controller_profile.png?raw=true) for a detailed walk through.
...
* Return to the vedge device, exit from vshell mode and register with the UUID and OTP
  ```
