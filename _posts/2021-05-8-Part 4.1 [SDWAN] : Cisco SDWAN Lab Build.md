...
---
# Part (4) Cisco SDWAN Lab Deployment (**in progress**)
...
I could have jumped straight into vManage APIs and Grafana dashboards, as there's already several great guides on SDWAN virtual lab deployment, but for completeness, I'm documenting the Virtual SDWAN Lab deployment as sites come and go.   We'll cover SD-WAN in two parts:
* (1) Documenting the lab build for anyone that's interested in building their own SDWAN sandbox for learning, demos, testing
...
* For Plug and Play, license management [codingpacket](https://codingpackets.com/blog/cisco-sdwan-self-hosted-lab-part-1/)
...
__Note__ Same image used for vbond and vedges. The system command **vbond [10.254.254.3] local**  designates the device to function as a vbond rather than vedge.
...
Refer to [codingpackets SDWAN Self Host Lab](https://github.com/j-sulliman/j-sulliman.github.io/blob/master/images/Plug_Play_Controller_profile.png?raw=true) for details.
...
```
* Copy the content of vBond.crt (__cat vSmart.crt__) and paste to **Configuration > Certificates > Controllers > Select vSmart** and "Install Certificate":
